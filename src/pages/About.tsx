...
const About = () => {
    ...
    return (
        <section id='about'>
            <div className={`${styles.paddingX} ${styles.paddingY} bg-background-1 flex flex-col items-center justify-center text-content`}>
                <div className="max-w-7xl flex flex-col sm:flex-row justify-center items-center  pt-16 gap-4">
                    ...
                    <div className="w-full lg:w-7/12 px-6">
                        ...
                        <h1 className="text-4xl tracking-wide font-bold py-4">Curious about me? Here you have it:</h1>
